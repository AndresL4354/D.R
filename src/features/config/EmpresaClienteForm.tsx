...
/** Exportado como `Component` para el `lazy` del router. Crear/editar empresa cliente. */
export function Component() {
  return <CatalogoForm tabla="empresa_cliente" singular="empresa cliente" backTo="/empresa-cliente" fields={FIELDS} />;
}
